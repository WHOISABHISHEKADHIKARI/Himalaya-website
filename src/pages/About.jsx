  ...
  return (
    <div style={{ backgroundColor: colors.background.primary }}>
            ...
            "@graph": [
              {
                ...
                "logo": "https://krishihimalaya.com/src/assets/logo/whitelogo-blackbg-removebg-previewaa.webp",
                "sameAs": [
      ...
      <section className="relative py-24">
        <div className="absolute inset-0 bg-gradient-to-r from-green-800/20 via-yellow-600/10 to-green-800/20 rounded-[2.5rem] blur-2xl transition-all duration-700"></div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="relative group perspective-1000">
                <div className="absolute inset-0 bg-gradient-to-r from-green-800/20 via-yellow-600/10 to-green-800/20 rounded-[2.5rem] blur-2xl transition-all duration-700 group-hover:blur-3xl group-hover:scale-105 animate-pulse"></div>
                <div className="bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-white/95 via-white/90 to-white/80 backdrop-blur-2xl p-8 rounded-[2.5rem] border border-white/30 shadow-[0_8px_32px_rgba(28,78,55,0.15)] hover:shadow-[0_32px_80px_rgba(28,78,55,0.3)] transition-all duration-700 relative h-full overflow-hidden transform-gpu group-hover:translate-y-[-8px] hover:border-green-800/30">
                  <div className="absolute -top-20 -right-20 w-40 h-40 bg-yellow-600/5 rounded-full blur-3xl group-hover:blur-4xl transition-all duration-700"></div>
                  ...
                  <div className="text-center relative z-10">
                    <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300" style={{ background: `linear-gradient(135deg, ${colors.primary}, ${colors.secondary})` }}>
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                      </svg>
                    </div>
                    <h3 className="text-2xl font-bold mb-4" style={{ color: colors.text.dark }}>
                      Murrah-Based Dairy
                    </h3>
                    <p className="leading-relaxed" style={{ color: colors.text.medium }}>
                    ...
                    {videoError && (
                      <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                        ...
                        <p className="text-red-500 text-xs">
                          The video file is temporarily unavailable. This may be due to the large file size (49MB) or network issues. 

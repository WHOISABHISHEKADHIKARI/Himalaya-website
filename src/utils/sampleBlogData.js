...
By combining traditional wisdom with modern technology, Himalayan farmers can achieve better yields while preserving the environment for future generations.`,
        ...
        featuredImage: null,
        category: BLOG_CONFIG.getCategories().find(c => c.name === "Sustainable Agriculture"),
        tags: [BLOG_CONFIG.getTags().find(t => t.name === "Sustainability"), BLOG_CONFIG.getTags().find(t => t.name === "Traditional Farming")],
...
Organic farming not only produces healthier food but also improves soil health and supports biodiversity.`,
        ...
        featuredImage: null,
        category: BLOG_CONFIG.getCategories().find(c => c.name === "Organic Farming"),
        tags: [BLOG_CONFIG.getTags().find(t => t.name === "Organic"), BLOG_CONFIG.getTags().find(t => t.name === "Vegetables")],
        author: "Priya Thapa",
...
The future of mountain agriculture depends on our ability to adapt and implement these climate-smart practices effectively.`,
        ...
        featuredImage: null,
        category: BLOG_CONFIG.getCategories().find(c => c.name === "Climate Change"),
        tags: [BLOG_CONFIG.getTags().find(t => t.name === "Climate Change"), BLOG_CONFIG.getTags().find(t => t.name === "Innovation")],
...
By combining traditional wisdom with modern techniques, we can ensure the preservation of our valuable seed heritage for future generations.`,
        ...
        featuredImage: null,
        category: BLOG_CONFIG.getCategories().find(c => c.name === "Traditional Knowledge"),
        tags: [BLOG_CONFIG.getTags().find(t => t.name === "Traditional Farming"), BLOG_CONFIG.getTags().find(t => t.name === "Seeds")],

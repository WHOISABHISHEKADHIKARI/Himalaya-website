...
const SEOHelmet = ({ navItems }) => {
  ...
  const getMetaContent = (pathname) => {
    switch(pathname) {
      ...
      case '/agriculture-support-policies':
        return {
          title: 'Agriculture Support Policies | Government Subsidies & Farming Assistance',
          description: 'Comprehensive agricultural support policies including government subsidy guidance, organic certification assistance, soil testing, crop planning, and farming equipment support. Expert help for successful sustainable farming in Nepal.',
          keywords: 'agriculture support policies nepal, government farming subsidies, organic certification help, soil testing services, crop planning assistance, farming equipment support',
          ogDescription: 'Complete agricultural support policies including government subsidies, certification help, and expert farming guidance in Nepal.'
        };
      case '/NewsAboutUs':
        return {
          title: 'News About Us | Latest Updates from Himalaya Krishi',
          description: 'Stay updated with the latest news and developments from Himalaya Krishi. Read about our achievements, new initiatives, and contributions to Nepal\'s agricultural sector.',
          keywords: 'himalaya krishi news, agricultural updates nepal, farming news, organic agriculture developments, agricultural achievements nepal',
          ogDescription: 'Latest news and updates from Nepal\'s leading organic agriculture center - Himalaya Krishi.'
        };
      case '/blog/cms':
         return {
